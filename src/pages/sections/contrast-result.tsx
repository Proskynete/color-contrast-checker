  ...
  return (
    <>
      <div className="w-full flex flex-col lg:flex-row gap-0.5">
        <div
          className={`w-full lg:w-2/3 flex flex-col justify-center text-center md:text-left p-4 rounded-t-xl lg:rounded-l-xl lg:rounded-r-none ${classification.styles} transition-colors duration-300`}
        >
        ...
        <div className="w-full lg:w-1/3 flex flex-col gap-0.5">
          {levels.map((level) => (
            <div
              key={level.title}
              className={`p-4 rounded-none lg:rounded-l-none transition-colors duration-300 ${
                level.styles
              }  ${
                level.key === "small"
                  ? "lg:rounded-tr-xl lg:rounded-br-none"
                  : "rounded-b-xl lg:rounded-br-xl lg:rounded-tr-none"
              }`}
            >
      ...
      <div className="w-8/10 min-h-9 mt-1 ml-2 lg:ml-3 text-pretty gap-1">
